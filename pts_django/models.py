...
class Subscriptions(models.Model):
	"""Base class for Subscriptions. Has man to many relation with Subscribers and Packages"""

	#Types of tags(as supported by present system).
	VALID_TAGS = (
			('bts', 'All Bugs'),
	...
	tag_name = models.CharField(max_length=30, choices=VALID_TAGS)
